...
import { n as CrmProvider } from "./store-DhJVG2kc.mjs";
...
import { t as AppShell } from "./AppShell-DDLS_o5o.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-D5IBpcBX.js
...
var Route$5 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Univerz CRM — calls & appointments" },
			{
				name: "description",
				content: "Internal call and appointment CRM for Univerz (Private) Ltd."
			}
		],
		links: [{
			rel: "stylesheet",
...
var PipelineRoute = Route$3.update({
	id: "/pipeline",
	path: "/pipeline",
	getParentRoute: () => Route$5
});
var ContactsRoute = Route$2.update({
	id: "/contacts",
	path: "/contacts",
	getParentRoute: () => Route$5
});
var AppointmentsRoute = Route$1.update({
	id: "/appointments",
	path: "/appointments",
	getParentRoute: () => Route$5
});
